"""Ported single_robot_sloam_test.launch."""
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[
                ...
                (f'/robot{host_robot_id}/semantic_meas_sync_odom', '/robot0/semantic_meas_sync_odom'),
                ('/sloam/odom', '/dragonfly67/quadrotor_ukf/control_odom'),
            ],
        ),
    ])
